  ...
  return (
    <div className="mx-auto w-full max-w-[1200px]">
      <div className="flex flex-col gap-3 rounded bg-[#1A1F29] py-6 text-white">
        <p className="font ml-6 text-[24px] font-bold ">Create a Presale</p>
