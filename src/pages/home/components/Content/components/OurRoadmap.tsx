...
const RoadmapDesktop = () => {
  const RoadmapDesktopItem = (props: any) => {
    return (
  ...
  return (
    <div className="relative h-[426px] min-w-[648px] min-[1440px]:h-[525.834px] min-[1440px]:min-w-[1247px]">
      <img
        src={icons.mdRoadmap}
        alt="roadmap"
        className="min-[1440px]: absolute top-[156px] w-full"
      />
...
const RoadmapSliderMobile: React.FC = () => {
  return (
    <ConfigProvider
      theme={{
        components: {
  ...
  return (
    <div className="mb-10 w-full">
      ...
      >
        ...
        <div className="font-['Roboto'] text-base font-bold text-white">
