...
const EcosystemCard = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="text-center font-['Exo_2'] text-base font-bold leading-normal">
          {title}
        </div>
        <div className="font-['Inter'] text-sm font-normal text-[#C6C6C6]">
          {description}
        </div>
      </div>
    </div>
...
const EcosystemListCardMobile = () => {
  const ecosystemCardItems = [
    ...
    },
    {
      ...
      title: "Starksport Exchange",
      subtitle:
        "Trade, lend or borrow unique digital items and make it valuable",
    },
    {
      icon: icons.ecosystem.ECOSYSTEM_6,
      title: "Starksport NFT",
      subtitle:
        "A limited collection belongs to early contributors with huge benefits",
    },
    {
